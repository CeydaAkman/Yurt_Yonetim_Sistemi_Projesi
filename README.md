...
1. Controller: Kullanıcı girdisini alır, UI'ı yönetir ve Service katmanını çağırır.

2. Service: İş mantığını yürütür, Repository'leri koordine eder.

3. Repository: Veritabanı erişimini soyutlar, JDBC işlemlerini yönetir.

4. Model: Uygulamanın verilerini temsil eder.
